# MNQ 15m ORB + VWAP Backtest Report

**Generated:** 2026-09-21 13:21:59 EDT  
**Symbol:** MNQ=F · **Size:** 1 Micro ($2/pt) · **Bars:** 5m (yfinance)  
**Window:** 2026-08-10 → 2026-09-21 (30 trading days, end 2026-09-21)  
**Data span:** 2026-07-13T00:00:00-04:00 → 2026-09-21T13:10:00-04:00

## Strategy params (exact)

- Opening range: **09:30–09:45 America/New_York** (3×5m) → ORH/ORL
- Entry: first post-OR 5m **close** beyond ORH (long) / ORL (short); **first break only**
- VWAP filter: **session VWAP from RTH open 09:30 NY**, typical price (H+L+C)/3; long iff close>VWAP, short iff close<VWAP
- SL: opposite OR; if entry-extended risk > $100 use **OR mid**; if still > $100 skip signal
- A/B: **C-skip day** if OR width × $2 > $100 (cannot place opposite-OR SL within risk cap at 1 contract)
...
- No scale / average / martingale / grid
...
## Session tag breakdown (entry time)
...
**drop** — only 1 trades / 29 days C-wide OR; net $150.00 — 15m MNQ OR rarely fits $100 risk at 1 contract

---
_Facts only from this fresh 15m ORB+VWAP run. Not the existing 30m ORB reports._